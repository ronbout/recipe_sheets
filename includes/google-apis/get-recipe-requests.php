...
function load_recipe_request_table($data, $dt) {
	...
	$recipe_requests_table = "rg_recipe_guru_requests";
	...
	update_request_table($requests_list, $dt);
}
...
function update_request_table($requests_list, $dt) {
	global $wpdb;

	$requests_table = 'rg_recipe_guru_requests';
