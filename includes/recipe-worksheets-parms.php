...
define('BRIEF_ORIG_CHILD_ID_COL', 12);
define('BRIEF_TIER_COL', 13);
define('BRIEF_WORKSHEET_ID_COL', 20);
define('BRIEF_VIRGIN_ID_COL', 21);
define('BRIEF_RECIPE_TYPE_COL', 22);
define('BRIEF_PARENT_RECIPE_ID_COL', 23);  // dummy internal column for matching catalog to original recipe
...
define('OCTOBER_WORKING_DOC_ID', '1h8hJJqr2sZ-FIlUHNqeI5AuvrYo7z185ARm7te3mJ7I');
...
define('OCTOBER_IMAGE_FOLDER_ID', '1TMKt0g_FcfCOVrOsAN4yKyBRi-AuVPlX' );
...
define('OCTOBER_IMAGES_REPORT_ID', '1bMZDLRC9oqkXnv5xNMx5nxC-n8qeYBGoOL3-KpWy5Jg' );
...
$recipe_worksheets_parms = array(
	...
	'2022-10-01' => array( 
		'worksheet_doc_id' => OCTOBER_WORKING_DOC_ID,
		'brief_doc_id' => BRIEF_ID,
		'brief_sheet_name' => 'October 2022',
